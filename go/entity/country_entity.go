...
type CountryEntity struct {
	name    string
	client  *core.CountriesAndCitiesSDK
...
func NewCountryEntity(client *core.CountriesAndCitiesSDK, entopts map[string]any) *CountryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CountryEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CountryCreateData and returns an Country. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CountryEntity) CreateTyped(reqdata CountryCreateData, ctrl map[string]any) (Country, error) {
