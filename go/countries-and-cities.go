...
// instead of `sdk.NewCountriesAndCitiesSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *CountriesAndCitiesSDK  { return NewCountriesAndCitiesSDK(nil) }
func Test() *CountriesAndCitiesSDK { return TestSDK(nil, nil) }
