...
const testSeed = `map[string]any{"entity": map[string]any{"city": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
