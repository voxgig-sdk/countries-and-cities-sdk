...
## Install
```bash
go get github.com/voxgig-sdk/countries-and-cities-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/countries-and-cities-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/countries-and-cities-sdk/go=../countries-and-cities-sdk/go
```
...
```go
// Create
created, _ := client.City(nil).Create(
...
| `City` | `(data map[string]any) CountriesAndCitiesEntity` | Create a City entity instance. |
| `Country` | `(data map[string]any) CountriesAndCitiesEntity` | Create a Country entity instance. |

### Entity interface (CountriesAndCitiesEntity)

All entities implement the `CountriesAndCitiesEntity` interface.
