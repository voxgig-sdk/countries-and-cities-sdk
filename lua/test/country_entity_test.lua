...
describe("CountryEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set COUNTRIES_AND_CITIES_TEST_COUNTRY_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    country_ref01_data = helpers.to_map(type(country_ref01_data_result) == 'table' and country_ref01_data_result.data_get and country_ref01_data_result:data_get() or country_ref01_data_result)
...
function country_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("COUNTRIES_AND_CITIES_TEST_COUNTRY_ENTID")
