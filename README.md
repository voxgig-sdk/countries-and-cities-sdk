...
Provides population and geographical data for countries and cities.

Learn more about Countries & Cities API at [countriesnow.space](https://countriesnow.space).
...
This SDK exposes the API as a small set of **semantic entities** — City and Country — that you
