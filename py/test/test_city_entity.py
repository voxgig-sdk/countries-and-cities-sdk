    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set COUNTRIES_AND_CITIES_TEST_CITY_ENTID JSON to run live")
        client = setup["client"]
        ...
        city_ref01_data = helpers.to_map(runner.entity_data(city_ref01_ent.create(city_ref01_data, None)))
...
def _city_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("COUNTRIES_AND_CITIES_TEST_CITY_ENTID"))
