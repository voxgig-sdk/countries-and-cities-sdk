# CountriesAndCities SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CountriesAndCitiesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CountriesAndCitiesSDK(...) and CountriesAndCitiesSDK.test(...) become
#      CountriesAndCitiesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "countriesandcities_sdk"
_SDK_CLASS = "CountriesAndCitiesSDK"
