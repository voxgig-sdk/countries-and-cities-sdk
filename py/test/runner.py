...
class CountriesAndCitiesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CountriesAndCitiesTestRunner.getenv("COUNTRIES_AND_CITIES_TEST_LIVE")
        override = CountriesAndCitiesTestRunner.getenv("COUNTRIES_AND_CITIES_TEST_OVERRIDE")
        ...
        explain = CountriesAndCitiesTestRunner.getenv("COUNTRIES_AND_CITIES_TEST_EXPLAIN")
...
def entity_data(v):
    return CountriesAndCitiesTestRunner.entity_data(v)
...
def live_client_options():
    return CountriesAndCitiesTestRunner.live_client_options()
