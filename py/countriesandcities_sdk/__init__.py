...
from countriesandcities_sdk.utility import register

# Load features
from countriesandcities_sdk.feature.base_feature import CountriesAndCitiesBaseFeature
from countriesandcities_sdk.features import _has_feature, _make_feature
...
class CountriesAndCitiesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CountriesAndCitiesUtility()
        self._utility = utility

        from countriesandcities_sdk.config import shared_config
    ...
    def get_utility(self):
        return CountriesAndCitiesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CountriesAndCitiesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def City(self, data=None) -> "CityEntity":
        ...
        from countriesandcities_sdk.entity.city_entity import CityEntity
    ...
    def Country(self, data=None) -> "CountryEntity":
        ...
        from countriesandcities_sdk.entity.country_entity import CountryEntity
