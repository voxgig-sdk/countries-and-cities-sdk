// Command CountriesAndCities-mcp is an MCP server exposing the CountriesAndCities
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CountriesAndCities_list  — list records of an entity
//	CountriesAndCities_load  — load a single record of an entity
//
