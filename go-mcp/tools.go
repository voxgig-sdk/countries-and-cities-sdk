...
type Args struct {
	Entity string         `json:"entity" jsonschema:"city | country"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CountriesAndCitiesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "countries-and-cities_list",
		Description: "List records from CountriesAndCities. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "countries-and-cities_load",
		Description: "Load a single record from CountriesAndCities. " +
...
func runOp(client *sdk.CountriesAndCitiesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CountriesAndCitiesSDK, name string) (sdk.CountriesAndCitiesEntity, error) {
