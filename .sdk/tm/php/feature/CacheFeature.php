...
// CountriesAndCities SDK cache feature
...
class CountriesAndCitiesCacheFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _through(CountriesAndCitiesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
