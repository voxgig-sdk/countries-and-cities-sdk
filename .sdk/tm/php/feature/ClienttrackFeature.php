...
// CountriesAndCities SDK clienttrack feature
...
class CountriesAndCitiesClienttrackFeature extends CountriesAndCitiesBaseFeature
{
    ...
    public function PostConstruct(CountriesAndCitiesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CountriesAndCities-SDK';
