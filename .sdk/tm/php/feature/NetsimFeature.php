...
// CountriesAndCities SDK netsim feature
...
class CountriesAndCitiesNetsimFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _simulate(CountriesAndCitiesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CountriesAndCitiesContext $ctx, array $applied): void
    {
        $client = $this->client;
