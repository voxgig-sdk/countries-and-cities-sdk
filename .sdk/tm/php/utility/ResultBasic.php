...
// CountriesAndCities SDK utility: result_basic

class CountriesAndCitiesResultBasic
{
    public static function call(CountriesAndCitiesContext $ctx): ?CountriesAndCitiesResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof CountriesAndCitiesError) ? $result->err->msg : (string)$result->err;
