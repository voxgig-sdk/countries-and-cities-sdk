...
// CountriesAndCities SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CountriesAndCitiesMakeRequest
{
    public static function call(CountriesAndCitiesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CountriesAndCitiesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CountriesAndCitiesResponse($fetched);
        } else {
