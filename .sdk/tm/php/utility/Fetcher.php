...
// CountriesAndCities SDK utility: fetcher

class CountriesAndCitiesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CountriesAndCitiesSDK/1.0)';
    ...
    public static function call(CountriesAndCitiesContext $ctx, string $fullurl, array $fetchdef): array
    {
