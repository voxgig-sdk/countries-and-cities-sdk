...
// CountriesAndCities SDK utility: make_options

class CountriesAndCitiesMakeOptions
{
    ...
    public static function call(CountriesAndCitiesContext $ctx): array
    {
        ...
        //
        // `CountriesAndCitiesSchema::optspec()` is built from the model:
        ...
        $optspec = CountriesAndCitiesSchema::optspec();
