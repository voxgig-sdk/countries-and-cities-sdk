...
// CountriesAndCities SDK utility type

class CountriesAndCitiesUtility
{
    ...
    public static function copy(CountriesAndCitiesUtility $src): CountriesAndCitiesUtility
    {
        $u = new CountriesAndCitiesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
