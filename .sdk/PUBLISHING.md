...
|---|---|---|
| `ts/` | @voxgig-sdk/countries-and-cities-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/countries-and-cities-sdk \
      --repository voxgig-sdk/countries-and-cities-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/countries-and-cities-sdk` shows it, and
`npm trust revoke @voxgig-sdk/countries-and-cities-sdk --id=<id>` removes it.
