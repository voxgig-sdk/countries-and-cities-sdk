...
// CountriesAndCities SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CountriesAndCitiesSDK::test)
...
{
    private const SDK_CLASS = 'CountriesAndCitiesSDK';
    ...
    private const SDK_BASE = 'countriesandcities_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../countriesandcities_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
