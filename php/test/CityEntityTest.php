...
class CityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COUNTRIES_AND_CITIES_TEST_CITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $city_ref01_data = Helpers::to_map(is_object($city_ref01_data_result) && method_exists($city_ref01_data_result, 'data_get') ? $city_ref01_data_result->data_get() : $city_ref01_data_result);
...
function city_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COUNTRIES_AND_CITIES_TEST_CITY_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["COUNTRIES_AND_CITIES_TEST_CITY_ENTID"]);
