...
// CountriesAndCities SDK utility: graphql
//
...
class CountriesAndCitiesGraphql
{
    ...
    // equivalent.
    public static function body(CountriesAndCitiesContext $ctx): mixed
    {
    ...
    public static function errors(CountriesAndCitiesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
