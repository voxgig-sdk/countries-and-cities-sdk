...
// CountriesAndCities SDK streaming feature
...
class CountriesAndCitiesStreamingFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _iterate(CountriesAndCitiesResult $result): \Generator
    {
    ...
    private function _streamable(CountriesAndCitiesContext $ctx): bool
    {
