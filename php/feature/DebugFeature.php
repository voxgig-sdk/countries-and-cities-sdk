...
// CountriesAndCities SDK debug feature
...
class CountriesAndCitiesDebugFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _finish(CountriesAndCitiesContext $ctx, bool $ok): void
    {
