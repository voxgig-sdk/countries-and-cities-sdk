...
// CountriesAndCities SDK rbac feature
...
class CountriesAndCitiesRbacFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _required(CountriesAndCitiesContext $ctx): ?string
    {
    ...
    private function _reject(CountriesAndCitiesContext $ctx, string $required): void
    {
    ...
    private function _track(CountriesAndCitiesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
