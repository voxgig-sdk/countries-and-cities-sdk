...
// CountriesAndCities SDK timeout feature
...
class CountriesAndCitiesTimeoutFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _with_timeout(CountriesAndCitiesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CountriesAndCitiesContext $_ctx, float $ms): void
    {
        $client = $this->client;
