...
// CountriesAndCities SDK ratelimit feature
...
class CountriesAndCitiesRatelimitFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _acquire(CountriesAndCitiesContext $ctx): void
    {
    ...
    private function _track(CountriesAndCitiesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
