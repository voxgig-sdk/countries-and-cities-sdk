...
// CountriesAndCities SDK audit feature
...
class CountriesAndCitiesAuditFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _emit(CountriesAndCitiesContext $ctx, string $outcome): void
    {
