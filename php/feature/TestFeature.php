...
// CountriesAndCities SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CountriesAndCitiesTestFeature extends CountriesAndCitiesBaseFeature
{
    ...
    public function init(CountriesAndCitiesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CountriesAndCitiesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CountriesAndCitiesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CountriesAndCitiesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CountriesAndCitiesContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = CountriesAndCitiesParam::call($ctx, $k);
