...
// CountriesAndCities SDK proxy feature
...
class CountriesAndCitiesProxyFeature extends CountriesAndCitiesBaseFeature
{
    ...
    public function init(CountriesAndCitiesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CountriesAndCitiesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
