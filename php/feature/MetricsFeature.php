...
// CountriesAndCities SDK metrics feature
...
class CountriesAndCitiesMetricsFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _record(CountriesAndCitiesContext $ctx, bool $ok): void
    {
