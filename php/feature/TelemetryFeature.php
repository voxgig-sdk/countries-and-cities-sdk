...
// CountriesAndCities SDK telemetry feature
...
class CountriesAndCitiesTelemetryFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _close(CountriesAndCitiesContext $ctx, bool $ok): void
    {
