...
// CountriesAndCities SDK idempotency feature
...
class CountriesAndCitiesIdempotencyFeature extends CountriesAndCitiesBaseFeature
{
    ...
    private function _mutating(CountriesAndCitiesContext $ctx): bool
    {
