...
#      offline in seeded test mode (CountriesAndCitiesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CountriesAndCities_sdk.rb")
  SDK_CLASS = "CountriesAndCitiesSDK"
  ...
  SDK_BASE = "CountriesAndCities_sdk"
