...
The Ruby SDK for the CountriesAndCities API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `CountriesAndCitiesError` (a `StandardError` subclass), so wrap
