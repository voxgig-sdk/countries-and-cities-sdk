# CountriesAndCities Ruby SDK

The Ruby SDK for the CountriesAndCities API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
```ruby
# Create
created, _ = client.City(nil).create({ "name" => "Example" }, nil)
...
result, err = client.CountriesAndCities(nil).load(
  { "id" => "test01" }, nil
)
