// Command CountriesAndCities-cli is a CLI + REPL for the CountriesAndCities SDK,
...
const prompt = "countries-and-cities"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "city country"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      COUNTRIES_AND_CITIES_APIKEY (api key), COUNTRIES_AND_CITIES_BASE (base url override)")
