...
AQL-driven CLI and REPL for the CountriesAndCities SDK. Positional arguments are
...
```sh
go build -o countries-and-cities-cli ./...
```
...
./countries-and-cities-cli load 1 city
./countries-and-cities-cli load '{id:1}' city
