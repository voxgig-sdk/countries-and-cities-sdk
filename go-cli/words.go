...
func registerSDKWords(r *eng.Registry, client *sdk.CountriesAndCitiesSDK) {
...
func runOp(client *sdk.CountriesAndCitiesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
