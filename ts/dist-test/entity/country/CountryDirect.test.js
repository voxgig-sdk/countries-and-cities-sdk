...
(0, node_test_1.describe)('CountryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CountriesAndCitiesSDK({
...
function liveScenariosActive() { return false && process.env.COUNTRIES_AND_CITIES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CountriesAndCitiesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['COUNTRIES_AND_CITIES_TEST_COUNTRY_ENTID'];
    ...
    const client = new __1.CountriesAndCitiesSDK({
        base: 'http://localhost:8080',
