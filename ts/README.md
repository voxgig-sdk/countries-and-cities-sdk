...
The TypeScript SDK for the CountriesAndCities API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new CountriesAndCitiesSDK({ apikey: '...' })
